    ...
    <>
      ...
      >
        ...
        >
          ...
          makes every trip safe, comfortable, and hassle-free. Choose from
          curated tour packages or customize your own adventure
        </Typography>
      </Box>
      ...
      <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
        ...
        >
          ...
          >
            Not just office rides — we make your holidays and getaways smoother
            with our specially designed tour packages. Travel in comfort,
            explore with ease, and create memories that last
          </Typography>
          ...
          >
            {[ToursCard1, ToursCard2, ToursCard3, ToursCard4].map(
              (img, index) => {
                const titles = [
                  "Weekend Getaways",
                  "City Sightseeing",
      ...
      >
        ...
        >
          ...
          >
            ...
            trusted drivers and well-maintained vehicles dedicated to your peace
            of mind.
          </Typography>
        </Box>
        <ContactUs />
